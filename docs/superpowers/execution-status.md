...
- [M4-8] Scan Tab 占位页 — status: `in_progress` · updated: 2026-07-07 20:17:53
...
- M4 三大页面 — status: `in_progress` · completed 7 / total 8 · blocked 0 · in_progress 1
...
<!-- task-status-state
{
  "current": {
    ...
    "finished_at": "2026-07-07 20:16:17",
    "plan_ref": "M4-8",
  ...
  "plan": {
    "tasks": {
      ...
      "M4-8": {
        "status": "in_progress",
        "updated_at": "2026-07-07 20:17:53",
        "summary": "Design Scan Tab placeholder",
        "title": "Scan Tab 占位页",
        "milestone": "M4"
      }
