...
- 状态：进行中
- 计划编号：M4-3
- 最近开始：2026-07-07 18:26:33
- 最近完成：2026-07-07 18:20:30
- 最近验证：未记录
- 最近任务摘要：Design Search page
...
- [M4-3] Search 页面 — status: `in_progress` · updated: 2026-07-07 18:26:33
...
- M4 三大页面 — status: `in_progress` · completed 2 / total 8 · blocked 0 · in_progress 1
...
<!-- task-status-state
{
  "current": {
    "status": "进行中",
    "started_at": "2026-07-07 18:26:33",
    "finished_at": "2026-07-07 18:20:30",
    "plan_ref": "M4-3",
  ...
  "plan": {
    "tasks": {
      ...
      "M4-3": {
        "status": "in_progress",
        "updated_at": "2026-07-07 18:26:33",
        "summary": "Design Search page",
        "title": "Search 页面",
        "milestone": "M4"
      }
