...
| [App 9 Scan 免费额度](../00-product/TCG_Card_App_v1.1_PRD.md#9-scan-免费额度)、[扫描识别流程](../01-flows/scan-recognition.md) | [额度账本](../../../../apps/workers-api/src/scan/quota.ts)、[识别路由](../../../../apps/workers-api/src/scan/routes.ts)、[App Queue](../../../../apps/flutter-app/lib/features/scan/scan_page.dart)、[Flutter recognizer](../../../../apps/flutter-app/lib/shared/scan/scan_card_recognizer_native.dart)、[mask 几何](../../../../apps/flutter-app/lib/shared/scan/scan_mask_geometry.dart)、[Android Runtime](../../../../apps/flutter-app/android/app/src/main/kotlin/com/cardai/tcg/ScanModelRuntime.kt)、[iOS Runtime](../../../../apps/flutter-app/ios/Runner/ScanModelRuntime.swift)、迁移 `0030` | `quota.integration.test.ts`、`routes.test.ts`、`scan_api_client_test.dart`、`scan_mask_geometry_test.dart`、`scan_result_source_test.dart`、`scan_page_test.dart`；另有 ONNX/ORT 数值对比、四 ABI native 构建、AAR JNI/ELF/16 KiB 对齐校验 | 代码和模型制品已完成；当前机器缺少 Flutter/Dart，且未完成双端真机、最终 release 体积、真实 Service Binding、Sandbox/TestFlight、真实并发/中断和卡牌集准确率验收。 |
