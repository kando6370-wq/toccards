...
- 当前代码与部署基线：2026-09-22 Linux API/Admin 运行 `dev@c0dd7a2`，包含请求关联和 Admin 内网 HTTP UUID fallback；客户端源码版本为 `1.0.3+156`，最近测试包 156 包含共享原生传输，但移动端协议与扫描内存仍需真机验收。`dev-inner@b941a3f` 与 `dev@8e22c1d` 分别保留为 2026-09-15 整改和 2026-08-26 原始设计基线。
