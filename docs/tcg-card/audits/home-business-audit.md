...
| Flutter 全量测试 | 389 项通过、1 项因缺少平台 dartcv 动态库明确跳过 | 2026-07-17 machine reporter 验证 |
| Flutter analyze | 无问题 | 2026-07-17 本地验证 |
| Workers 全量验证 | 28 个测试文件、251 项通过；TypeScript 与 dry-run 通过 | 2026-07-17 本地验证 |
| iOS unsigned Release | 当前 Flutter 提交 `1337abe` 上 Ruby、Fastlane、Pods、lockfile 无漂移及 Release 构建全部成功 | GitHub Actions run `29566250750` |
| 代码提交 | HOME 动态数据、Scan 估值事件、owner 迁移与真实 R2 卡图均分段提交 | `bcc5737`、`04a555f`、`33b8bc9`、`5aa0772`、`6fc05da`、`f3e4b2e`、`670b782` |
| Cloudflare | 当前生产 Worker 版本为 `496065fb-5954-4700-b971-039973f043a9` | `wrangler deployments list` |
