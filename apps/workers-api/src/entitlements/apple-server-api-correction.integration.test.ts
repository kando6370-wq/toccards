...
describe("Apple Server API purchase-chain correction", () => {
  ...
  beforeEach(async () => {
    ...
    await db.batch([
      ...
      db.prepare("INSERT INTO apple_notification_inbox (id, payload_sha256, request_json, signed_payload, processing_status, attempts, received_at) VALUES ('inbox-1', 'hash-1', '{}', 'jws', 'correction_required', 1, ?)").bind(NOW.toISOString()),
