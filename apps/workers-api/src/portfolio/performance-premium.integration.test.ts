...
describe("Premium Performance routes", () => {
  ...
  beforeEach(async () => {
    ...
    await db.batch([
      ...
      db.prepare("INSERT INTO price_current_snapshot VALUES ('batch-1', 1, '2026-08-01', 20000000, NULL, NULL, NULL, NULL, NULL)"),
...
const SCHEMA = [
  ...
  "CREATE TABLE price_current_snapshot (batch_id TEXT NOT NULL, series_id INTEGER NOT NULL, observed_on TEXT NOT NULL, amount_micros INTEGER NOT NULL, baseline_1d_on TEXT, baseline_1d_amount_micros INTEGER, baseline_30d_on TEXT, baseline_30d_amount_micros INTEGER, change_1d_percent REAL)",
