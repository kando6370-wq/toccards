...
const SCHEMA = [
  ...
  "CREATE UNIQUE INDEX uq_collection_item_sku ON collection_item (owner_type, owner_id, folder_id, card_ref, ifnull(finish, ''), ifnull(language, ''), grader, ifnull(condition, ''), ifnull(grade, -1))",
